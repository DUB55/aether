                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {[
                    ...
                    <motion.div 
                      ...
                      className={cn(
                        "relative p-8 bento-card transition-all group cursor-pointer overflow-hidden",
                    ...
                    >
                      <div className="absolute inset-0 bg-gradient-to-br from-blue-900/0 via-blue-900/0 to-blue-900/0 group-hover:from-blue-900/20 group-hover:via-blue-900/10 group-hover:to-transparent transition-all duration-1000 animate-pulse" />
...
/ /   F o r c e   f r e s h   d e p l o y m e n t   -   0 4 / 0 8 / 2 0 2 6   0 0 : 0 8 : 2 3  
 