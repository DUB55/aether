      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <div className="flex items-center gap-3 mb-2">
            {icons[type]}
            <DialogTitle className="text-[var(--t)]">{title}</DialogTitle>
          </div>
          <DialogDescription className="text-[var(--t2)] text-left">
            {message}
          </DialogDescription>
        </DialogHeader>
          ...
          {type === 'confirm' ? (
            <>
              ...
              <Button
                ...
                className="bg-[var(--t)] text-[var(--bg)] hover:opacity-90"
              >
                {confirmText}
              </Button>
            </>
