...
export default function HomePage() {
  ...
  const handleStartProject = async (prompt: string) => {
    ...
    const newProject: Project = {
      ...
      files: {
        "src/app/page.tsx": `"use client"\n\nexport default function Home() {\n  return (\n    <main className="flex min-h-screen flex-col items-center justify-between p-24 bg-slate-50 dark:bg-slate-950">\n      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">\n        <p className="fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30">\n          Welcome to Aether\n        </p>\n      </div>\n      <div className="flex flex-col items-center gap-4">\n        <h1 className="text-4xl font-bold text-slate-900 dark:text-white">Your AI Project</h1>\n        <p className="text-slate-600 dark:text-slate-400">Generated from: ${prompt}</p>\n      </div>\n    </main>\n  )\n}`,
        "src/components/ui/button.tsx": `export function Button({ children, className, ...props }: any) {\n  return (\n    <button \n      className={\`px-4 py-2 rounded-lg bg-primary text-primary-foreground font-bold hover:opacity-90 transition-all \${className}\`} \n      {...props}\n    >\n      {children}\n    </button>\n  )\n}`,
        "package.json": `{\n  "name": "aether-project",\n  "version": "1.0.0",\n  "dependencies": {\n    "next": "latest",\n    "react": "latest",\n    "lucide-react": "latest"\n  }\n}`,
          ...
          <div key="landing-wrapper" className="w-full relative min-h-screen">
            ...
            >
              ...
              <div className="max-w-4xl w-full text-center space-y-8">
                ...
                >
                  Build the future <br />
                  <span className="bg-gradient-to-r from-slate-900 via-slate-700 to-slate-500 dark:from-white dark:via-slate-200 dark:to-slate-400 bg-clip-text text-transparent">with Aether AI</span>
                </motion.h1>
